...
* Prefer clear code over clever code. The Go team keeps repeating this mantra in their best-practice primers.
...
* Reread Go Proverbs — most apply directly to concurrent code (“don’t communicate by sharing memory; share memory by communicating”).
...
Want this turned into a starter repo (HTTP server with `slog`, `otelhttp`, graceful shutdown, `Makefile`, and CI running vet/staticcheck/govulncheck)?

[1]: https://staticcheck.dev/docs/?utm_source=chatgpt.com "Welcome to Staticcheck"
[2]: https://go.dev/wiki/CodeReviewComments "Go Wiki: Go Code Review Comments - The Go Programming Language"
[3]: https://go.dev/doc/go1.21?utm_source=chatgpt.com "Go 1.21 Release Notes"
[4]: https://go.dev/doc/effective_go?utm_source=chatgpt.com "Effective Go"
[5]: https://github.com/uber-go/guide?utm_source=chatgpt.com "The Uber Go Style Guide."
[6]: https://pkg.go.dev/cmd/vet?utm_source=chatgpt.com "vet command - cmd/vet"
[7]: https://go.dev/ref/mod?utm_source=chatgpt.com "Go Modules Reference"
[8]: https://go.dev/doc/toolchain?utm_source=chatgpt.com "Go Toolchains"
[9]: https://go.dev/doc/tutorial/workspaces?utm_source=chatgpt.com "Tutorial: Getting started with multi-module workspaces"
[10]: https://pkg.go.dev/slices?utm_source=chatgpt.com "slices package"
[11]: https://pkg.go.dev/log/slog?utm_source=chatgpt.com "slog package - log/slog"
[12]: https://go.dev/doc/go1.22?utm_source=chatgpt.com "Go 1.22 Release Notes"
[13]: https://go.dev/blog/randv2?utm_source=chatgpt.com "Evolving the Go Standard Library with math/rand/v2"
[14]: https://go.dev/doc/go1.23?utm_source=chatgpt.com "Go 1.23 Release Notes"
[15]: https://pkg.go.dev/fmt?utm_source=chatgpt.com "fmt package - fmt"
[16]: https://pkg.go.dev/errors?utm_source=chatgpt.com "errors package"
[17]: https://go.dev/doc/go1.20?utm_source=chatgpt.com "Go 1.20 Release Notes"
[18]: https://go.dev/doc/database/cancel-operations?utm_source=chatgpt.com "Canceling in-progress operations"
[19]: https://pkg.go.dev/golang.org/x/sync/errgroup?utm_source=chatgpt.com "errgroup package - golang.org/x/sync ..."
[20]: https://go.dev/ref/mem?utm_source=chatgpt.com "The Go Memory Model"
[21]: https://pkg.go.dev/net/http?utm_source=chatgpt.com "net/http"
[22]: https://victoriametrics.com/blog/go-graceful-shutdown/?utm_source=chatgpt.com "Graceful Shutdown in Go: Practical Patterns"
[23]: https://pkg.go.dev/go.opentelemetry.io/contrib/instrumentation/net/http/otelhttp?utm_source=chatgpt.com "otelhttp"
[24]: https://opentelemetry.io/docs/languages/go/getting-started/?utm_source=chatgpt.com "Getting Started"
[25]: https://pkg.go.dev/runtime/pprof?utm_source=chatgpt.com "runtime/pprof"
[26]: https://go.dev/wiki/TableDrivenTests?utm_source=chatgpt.com "Go Wiki: TableDrivenTests"
[27]: https://pkg.go.dev/testing?utm_source=chatgpt.com "testing package"
[28]: https://pkg.go.dev/gotest.tools/v3/golden?utm_source=chatgpt.com "golden package - gotest.tools/v3/golden"
[29]: https://go.dev/doc/tutorial/govulncheck?utm_source=chatgpt.com "Tutorial: Find and fix vulnerable dependencies with ..."
